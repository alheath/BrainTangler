...
public final class ExampleJigsawConfigurations {
    ...
    public static Bundle getKittenExample() {
        // Initialization
        Bundle config = new Bundle();//Constructs a new, empty Bundle
        ...
        // Image
        image.putBoolean("is_local", true);//putBoolean(String key, boolean value) : Inserts a Boolean value into the mapping of this Bundle, replacing any existing value for the given key.
        image.putInt("img_id", R.drawable.kitten_large);//putInt(String key, int value) : Inserts an int value into the mapping of this Bundle, replacing any existing value for the given key.
        image.putString("img_url", null);//putString(String key, String value) : Inserts a String value into the mapping of this Bundle, replacing any existing value for the given key.
        ...
        for (int h = 0; h < 2; h++) {
            for (int w = 0; w < 3; w++) {
                ...
                p.putInt("r", h);
                p.putInt("c", w);
                pieces.putBundle(key, p);//putBundle(String key, Bundle value) : Inserts a Bundle value into the mapping of this Bundle, replacing any existing value for the given key.
            }
        }
